...
{
	public static String remoteHostName = "127.0.0.1"; //Writer server host name
	public static int remotePort = 7000;           //Writer server port number
	public static int port = 6000;                 //local port number to start processor
